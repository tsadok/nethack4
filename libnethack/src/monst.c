 ...
 */
    MON("hobbit", S_HUMANOID,
        LVL(1, 9, 10, 0, 6), (G_NOHELL | G_GENO | 2),
    ...
    MON("dwarf", S_HUMANOID,
        LVL(2, 6, 10, 10, 4), (G_NOHELL | G_GENO | 3),
    ...
    MON("dwarf lord", S_HUMANOID,
        LVL(4, 6, 10, 10, 5), (G_NOHELL | G_GENO | 2),
    ...
    MON("dwarf king", S_HUMANOID,
        LVL(6, 6, 10, 20, 6), (G_NOHELL | G_GENO | 1),
 ...
 */
    ...
    MON("tengu", S_IMP,
        LVL(6, 13, 5, 30, 7), (G_NOHELL | G_GENO | 3),
 ...
 */
    ...
    MON("fire giant", S_GIANT,
        LVL(9, 12, 4, 5, 2), (G_NOHELL | G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
