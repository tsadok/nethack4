...
extern void deliver_all_mons(void);
extern boolean mon_arrive(struct monst *, enum migration);
...
extern boolean In_quest(const struct level *lev);
...
extern boolean mnexto(struct monst *);
...
extern void fixup_shk(struct monst *shkp, boolean ghostly, struct level *lev);
